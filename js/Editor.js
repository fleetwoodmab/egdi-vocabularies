...
`);
    ...
    keepAlive: function () {
        ...
        $.ajax({
            type: "GET",
            url: "http://geoinformation.dev/ws/keep_aliveCors.php", //#TODO
            ...
            topicRows.each(function (index) {
                ...
                content.each(function (index) {
                    ...
                    if (Editor.TOPIC_LIST.includes(attr)) {
                        ...
                        $.ajax({
                            type: "POST",
                            url: "http://geoinformation.dev/ws/get_topicCors.php", //#TODO
    ...
    handleLogin: function () {
        ...
        $.ajax({
            type: "POST",
            url: "http://geoinformation.dev/ws/loginCors.php", //#TODO
            //url: "ws/login.php",
    ...
    saveAttribute: function () {
        ...
        $.ajax({
            ...
            url: "http://geoinformation.dev/ws/write_topicCors.php", //#TODO
        ...
        $.ajax({
          type: "POST",
          url: "http://geoinformation.dev/editor/ws/mail.php", //#TODO

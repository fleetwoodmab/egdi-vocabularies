...
if (isset($_SERVER['PHP_AUTH_USER'])) {
        ...
        $err = "";
        if (!(checkNotNull($uri, "uri", $err) && checkNotNull($attribute, "attribute", $err) && checkNotNull(>
        ...
        toSQLInt($index);
        sqlExecute("INSERT INTO UpdateTickets(CREATED_USER,URI,PROPERTY,IDX,OLD_VALUE,NEW_VALUE,LANGUAGE,STATUS) VALUES (" . $user . "," . $uri . "," . $attribute . ", " . $index . ", " . $oldValue . ", " . $newValue . ", " . $la>");
        $result=Array(
                "status" => "ok"
        );
}
